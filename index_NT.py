import avize_NT as depune_la_neamt


id_lucrare = 53

path_final = r"G:\Shared drives\Root\11. DATABASE\Pentru Dragos"
...
# depune_la_neamt.aviz_GN_Delgaz(id_lucrare, path_final)
...
# depune_la_neamt.aviz_PMPN_Trafic(id_lucrare, path_final)

# depune_la_neamt.aviz_PMPN_Protocol_HCL(id_lucrare, path_final)

# depune_la_neamt.aviz_Publiserv(id_lucrare, path_final)

# depune_la_neamt.aviz_TransGaz(id_lucrare, path_final)
