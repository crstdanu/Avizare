...
def aviz_APM(id_lucrare, path_final):
    ...
    path_document_final = os.path.join(
        path_final, director_final, f"Documentatie aviz APM Neamț - {y['client']['nume']} conform CU {y['tblCU']['NrCU']} din {x.get_date(y['tblCU']['DataCU'])}.pdf")
...
def aviz_ApaServ(id_lucrare, path_final):
    ...
    path_document_final = os.path.join(
        path_final, director_final, f"Documentatie aviz ApaServ - {y['client']['nume']} conform CU nr. {y['tblCU']['NrCU']} din {x.get_date(y['tblCU']['DataCU'])}.pdf")
...
def aviz_Luxten(id_lucrare, path_final):
    ...
    path_document_final = os.path.join(
        path_final, director_final, f"Documentatie aviz Luxten - {y['client']['nume']} conform CU nr. {y['tblCU']['NrCU']} din {x.get_date(y['tblCU']['DataCU'])}.pdf")
...
def aviz_PMPN_Trafic(id_lucrare, path_final):
    ...
    path_document_final = os.path.join(
        path_final, director_final, f"Documentatie aviz PMPN - Trafic - {y['client']['nume']} conform CU nr. {y['tblCU']['NrCU']} din {x.get_date(y['tblCU']['DataCU'])}.pdf")
...
def aviz_PMPN_Protocol_HCL(id_lucrare, path_final):
    ...
    path_document_final = os.path.join(
        path_final, director_final, f"Documentatie aviz PMPN - Protocol - {y['client']['nume']} conform CU nr. {y['tblCU']['NrCU']} din {x.get_date(y['tblCU']['DataCU'])}.pdf")
...
def aviz_Publiserv(id_lucrare, path_final):
    ...
    path_document_final = os.path.join(
        path_final, director_final, f"Documentatie aviz Publiserv - {y['client']['nume']} conform CU nr. {y['tblCU']['NrCU']} din {x.get_date(y['tblCU']['DataCU'])}.pdf")
...
def aviz_GN_Prisma_Serv(id_lucrare, path_final):
    director_final = '16.Aviz GN - Prisma Serv'
    y = x.get_data(path_final, director_final, id_lucrare)
    ...
    model_cerere = (
        'G:/Shared drives/Root/11. DATABASE/01. Automatizari avize/MODELE/NT/16.Aviz GN - Prisma Serv/'f"Cerere Prisma Serv{' - DELGAZ' if y['lucrare']['IDClient'] == 1 else ''}.docx")
    ...
    path_document_final = os.path.join(
        path_final, director_final, f"Documentatie aviz GN - Prisma Serv - {y['client']['nume']} conform CU {y['tblCU']['NrCU']} din {x.get_date(y['tblCU']['DataCU'])}.pdf")
