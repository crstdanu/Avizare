...
def aviz_APM(id_lucrare, path_final):
    ...
    path_document_final = os.path.join(
        path_final, director_final, f"Documentatie aviz APM Iași - {y['client']['nume']} conform CU {y['tblCU']['NrCU']} din {x.get_date(y['tblCU']['DataCU'])}.pdf")
...
def aviz_Gazmir(id_lucrare, path_final):
    ...
    path_document_final = os.path.join(
        path_final, director_final, f"Documentatie aviz GN Gazmir - {y['client']['nume']} conform CU nr. {y['tblCU']['NrCU']} din {x.get_date(y['tblCU']['DataCU'])}.pdf")
...
def aviz_PMI_Mediu(id_lucrare, path_final):
    ...
    path_document_final = os.path.join(
        path_final, director_final, f"Documentatie aviz PMI Mediu - {y['client']['nume']} conform CU {y['tblCU']['NrCU']} din {x.get_date(y['tblCU']['DataCU'])}.pdf")
...
def aviz_PMI_SEn(id_lucrare, path_final):
    ...
    path_document_final = os.path.join(
        path_final, director_final, f"Documentatie aviz PMI - Serviciul energetic  - {y['client']['nume']} conform CU {y['tblCU']['NrCU']} din {x.get_date(y['tblCU']['DataCU'])}.pdf")
...
def aviz_PMI_GiS(id_lucrare, path_final):
    ...
    path_document_final = os.path.join(
        path_final, director_final, f"Documentatie aviz Cadastru - GiS - {y['client']['nume']} conform CU {y['tblCU']['NrCU']} din {x.get_date(y['tblCU']['DataCU'])}.pdf")
    ...
    x.copy_file(y['tblCU']['CaleRidicareTopoDWG'], path_final,
...
def aviz_Nomenclatura(id_lucrare, path_final):
    ...
    path_document_final = os.path.join(
        path_final, director_final, f"Documentatie Cerere nomenclatura urbana - {y['client']['nume']} conform CU {y['tblCU']['NrCU']} din {x.get_date(y['tblCU']['DataCU'])}.pdf")
...
def aviz_OAR(id_lucrare, path_final):
    ...
    model_cerere = (r"G:\Shared drives\Root\11. DATABASE\01. Automatizari avize\MODELE\IS\22.Aviz OAR\Cerere OAR.docx")
    ...
    model_email = (r"G:\Shared drives\Root\11. DATABASE\01. Automatizari avize\MODELE\IS\22.Aviz OAR\Model email.docx")
